<template>
    <div class="flex flex-col items-center gap-5">
        ...
        <h1 class="text-2xl font-semibold lg:text-3xl 2xl:text-4xl text-primary-500">{{ question }}</h1>
        ...
        <div class="flex gap-2">
            <button type="button" :disabled="activeStep < 1"
                class="flex items-center px-3 py-2 text-white bg-gray-700 gap-7 lg:gap-10 lg:px-4 lg:py-3" @click="setPreviosStep"
